        ...
        <div className="truck__wheel truck__wheel--front">
          ...
          <div className="truck-wheel">
            <div className="truck-wheel__rim">
              <div style={{ '--index': 0 }} className="truck-wheel__spoke" />
              <div style={{ '--index': 1 }} className="truck-wheel__spoke" />
              <div style={{ '--index': 2 }} className="truck-wheel__spoke" />
              <div style={{ '--index': 3 }} className="truck-wheel__spoke" />
              <div style={{ '--index': 4 }} className="truck-wheel__spoke" />
              <div style={{ '--index': 5 }} className="truck-wheel__spoke" />
              <div style={{ '--index': 6 }} className="truck-wheel__spoke" />
            </div>
          </div>
        </div>
...
const StyledWrapper = styled.div`
 display: flex;
  ...
  .truck {
    ...
    animation: driveForward 12s linear infinite;
