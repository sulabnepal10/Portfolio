        ...
        <StyledWrapper>
                ...
                <div className="card2">
                    <div className="upper">
                        <div className="humidity">
                            ...
                            <svg className="humiditysvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 30 30" xmlSpace="preserve">
          ...
          KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg==" />
                        ...
                        <div className="air">
                            ...
                            <svg xmlSpace="preserve" viewBox="0 0 30 30" height="30px" width="30px" y="0px" x="0px" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" className="airsvg">
            ...
            LTE3VDA4OjA0OjIyKzAwOjAwmxUCVQAAAABJRU5ErkJggg==" y={0} x={0} height={30} width={30} id="image0" />
                            </svg>
                        </div>
                    </div>
                    <div className="lower">
                        <div className="aqi">
                            <svg xmlSpace="preserve" viewBox="0 0 20 20" height="20px" width="20px" y="0px" x="0px" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" className="aqisvg">
                                <image href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
          ...
          MjUrMDA6MDBiirAvAAAAAElFTkSuQmCC" y={0} x={0} height={20} width={20} id="image0" />
                            </svg>
                            <div className="aqitext">AQI<br />30</div>
                        </div>
                        <div className="realfeel">
                            <svg xmlSpace="preserve" viewBox="0 0 20 20" height="20px" width="20px" y="0px" x="0px" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" className="rfsvg">
                                <image href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
          ...
          OFQwNToxNToyNiswMDowMIjQlfwAAAAASUVORK5CYII=" y={0} x={0} height={20} width={20} id="image0" />
                            </svg>
                            <div className="realfeeltext">Real Feel<br />21 °C</div>
                        </div>
                        <div className="pressure">
                            <svg xmlSpace="preserve" viewBox="0 0 20 20" height="20px" width="20px" y="0px" x="0px" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" className="pressuresvg">
                                <image href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
          ...
          Ut8AAAAASUVORK5CYII=" y={0} x={0} height={20} width={20} id="image0" />
                            </svg>
